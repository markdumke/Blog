...
date: '2017-11-03'
description: >
  Make matplotlib look like ggplot
---
...
<figure>
<center>
<img src = "iris_r.png" width = "400px" hspace="50"> 
<img src = "iris_matplotlib.png" width = "400px">
...
To make the matplotlib similar to the ggplot you can pass on a style argument. There is a `ggplot` style already available but I personally prefer the white background as in ggplot's `theme_bw`. So I adapted the mplstyle file and put it on  [Gist](https://gist.github.com/markusdumke/572e2a8546c54b322b48c0c792799b77).
